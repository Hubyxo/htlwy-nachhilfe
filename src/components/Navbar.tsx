...
const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: 'Nachhilfe finden', path: '/nachhilfe-finden' },
  ...
  const getSignUpPath = () => {
    if (location.pathname.includes('tutor-werden')) {
      return '/tutor-werden/formular';
    }
    if (location.pathname.includes('nachhilfe-finden')) {
      return '/nachhilfe-finden/formular';
    }
    return '/nachhilfe-finden/formular';
  };
